...
-- UserRole (назначение ролей сотрудникам)
-- Администраторы
INSERT INTO UserRole (employee_id, role_id) VALUES
(1, 1),  -- Михалков Н.И. — Администратор
(4, 1),  -- Прокопьев И.С. — Администратор
(7, 1),  -- Соколов Д.В. — Администратор
(10, 1), -- Павлова А.В. — Администратор
(13, 1), -- Козлов В.Г. — Администратор
(16, 1), -- Егоров О.Л. — Администратор
(19, 1), -- Белова Т.И. — Администратор
(22, 1), -- Лебедев К.А. — Администратор

-- Фотографы
(2, 2),  -- Юровская С.А. — Фотограф
(5, 2),  -- Волков А.С. — Фотограф
(8, 2),  -- Лебедева Н.С. — Фотограф
(11, 2), -- Орлов П.С. — Фотограф
(14, 2), -- Степанова С.А. — Фотограф
(17, 2), -- Никитина И.П. — Фотограф
(20, 2), -- Захаров Д.М. — Фотограф
(23, 2), -- Волкова М.Е. — Фотограф

-- Реставраторы
(3, 3),  -- Казырицкий В.Н. — Реставратор
(6, 3),  -- Морозова Е.И. — Реставратор
(9, 3),  -- Новиков И.А. — Реставратор
(12, 3), -- Федорова Е.Н. — Реставратор
(15, 3), -- Семёнов Н.Ю. — Реставратор
(18, 3), -- Виноградов М.Е. — Реставратор
(21, 3), -- Крылова Ю.А. — Реставратор
(24, 3), -- Орехов А.Р. — Реставратор

-- Операторы киосков
(25, 4), -- Киселева О.Г. — Оператор киоска
(26, 4), -- Соколов В.Н. — Оператор киоска
(27, 4), -- Максимова Е.Б. — Оператор киоска
(28, 4), -- Новиков И.А. — Оператор киоска
(29, 4), -- Павлова Л.М. — Оператор киоска
(30, 4), -- Викторов Р.Г. — Оператор киоска
(31, 4), -- Попов Н.В. — Оператор киоска
(32, 4); -- Козлов Д.Е. — Оператор киоска